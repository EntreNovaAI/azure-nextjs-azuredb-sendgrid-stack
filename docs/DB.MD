...
**Tables don't exist?**  
Run `bash scripts/dev/02_db_setup.sh` to execute migrations (or manually: `pnpm dlx tsx kysely/migration-script.ts`). In development mode, /nova should handle this automatically.
